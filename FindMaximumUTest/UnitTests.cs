...
namespace FindMaximumUTest
{
    ...
    public class UnitTests
    {
        ...
        [TestMethod]
        public void Given_Max_String_At_Second_Position_Should_Return_The_Max_String()
        {
            //Arrange
            string expected = "Peach";
            GetMaximum getMaxTestObj = new GetMaximum();
            //Act
            string result = getMaxTestObj.GetMaxString("Banana", "Peach", "Apple");
            //Assert
            Assert.AreEqual(expected, result);
        }
        [TestMethod]
        public void Given_Max_String_At_Third_Position_Should_Return_The_Max_String()
        {
            //Arrange
            string expected = "Peach";
            GetMaximum getMaxTestObj = new GetMaximum();
            //Act
            string result = getMaxTestObj.GetMaxString("Apple", "Banana", "Peach");
            //Assert
            Assert.AreEqual(expected, result);
        }
    }
